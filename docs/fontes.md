...
| S11 | Consolidação de Contas — **série 2021–2025** | `/cmguimaraes/uploads/document/file/<id>/consolidacao_de_contas_*.pdf` (via S39) | PDF | 2021–2025 | Anual | `empresas_municipais.json`: perímetro de consolidação (de 2023) e agregados do grupo municipal ano a ano | **Fonte-chave** para identificar o universo de entidades participadas e resolver os NIF dos contratos. **Consolida, não desagrega**: não traz o financeiro de cada entidade (L32) | `PRIM` |

...
| S32 | INE — Censos e estimativas de população | `https://www.ine.pt/` | INE | XLSX/API | **Denominador de todas as métricas per capita**; área; freguesias | Escolher e documentar uma única série (estimativa anual a 31-12) e usá-la em todo o dashboard | `URL-S` |
